...
merged_bl.to_csv("bl_matrix.txt",  index=False)

merged_v02.to_csv("v02_matrix.txt",  index=False)

merged_v04.to_csv("v04_matrix.txt",  index=False)

merged_v06.to_csv("v06_matrix.txt",  index=False)

merged_v08.to_csv("v08_matrix.txt",  index=False)
